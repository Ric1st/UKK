                    ...
                    <div class="card-body">
                        <form action="{{ route('bayar.store') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="input-group mb-3">
                                ...
                                <input type="text" class="form-control @error('nis') is-invalid @enderror" name="nis" value="{{Auth::user()->username}}" placeholder="Masukkan NIS Anda">
                                @error('content')
                            ...
                            <div class="input-group mb-3">
                                ...
                                <input type="text" class="form-control @error('nama') is-invalid @enderror" name="nama" value="{{Auth::user()->nama}}" placeholder="Masukkan Nama Lengkap Anda">
                                @error('content')
                                    <div class="alert alert-danger mt-2">
                                        {{ $message }}
                                    </div>
                            ...
                            <a href="{{route('bayar.index')}}" class="btn btn-danger">Kembali</a>
